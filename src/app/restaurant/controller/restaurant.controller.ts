...
export class RestaurantController {
    ...
    getById = async(req: Request, res: Response, next: NextFunction) => {
        try {
            const result = await this.restaurantService.findById(parseIdParam(req.params.id));
    ...
    update = async(req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            const result = await this.restaurantService.update(parseIdParam(req.params.id), req.user?.userId!, req.user?.role! as SystemRole, data);
    ...
    updateStatus = async(req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            const result = await this.restaurantService.updateStatus(parseIdParam(req.params.id), req.user?.role! as SystemRole, data);
